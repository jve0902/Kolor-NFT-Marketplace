        ...
        <div className="flex gap-16 bg-dashboard min-h-screen w-full">
          ...
          <div className="flex flex-col pt-48 w-full gap-8">
            <div className="flex w-full">
              <div className="flex flex-col w-3/5 border border-main rounded-3xl px-8 py-8 gap-6">
                ...
                <div className="flex">
                  ...
                  <div className="flex flex-row-reverse w-1/2 text-app-dark-400">1</div>
                </div>
                <div className="flex">
                ...
                <div className="flex">
                  ...
                  <div className="flex flex-row-reverse w-1/2 text-app-dark-400">1 $cUSD</div>
                </div>
                <div className="flex">
                  <div className="flex w-1/2 text-white">Date of purchase:</div>
                  <div className="flex flex-row-reverse w-1/2 text-app-dark-400">Viernes, 24 de junio de 2022, 12:25:30 h.</div>
                </div>
                <button className="rounded-full h-12 px-4 py-2 border border-main text-white w-40">Explore Land</button>
              </div>
              <div className="flex flex-col w-2/5 bg-token-detail mx-8 mr-24 rounded-3xl px-16 py-10 gap-10">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex gap-6">
                    <div className="px-5 py-5 bg-token-light rounded-3xl">
            ...
            <div className="text-white text-md text-investment">
              Investment porfolio
            </div>
            <div className="grid grid-cols-2 grid-flow-row gap-12 pr-24">
              {
