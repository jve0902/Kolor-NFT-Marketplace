...
const SideBar = () => {
  ...
  return (
    <div className="hidden md:flex flex-col min-w-96 max-w-80 bg-sidebar gap-4 px-6 xl:px-8 text-white">
      <div className={`justify-center items-center gap-4 flex cursor-pointer`} onClick={() => navigate('/')}>
        <img src={LogoIcon} alt="logo-icon" className="py-16 md:py-14 xl:py-12 w-12 md:w-16 xl:w-20" />
